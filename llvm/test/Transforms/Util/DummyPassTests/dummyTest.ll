...
7:                                                ; preds = %4, %7
  %8 = phi i64 [ 0, %4 ], [ %13, %7 ]
  call void @llvm.dbg.value(metadata i64 %8, metadata !18, metadata !DIExpression()), !dbg !21
...
8:                                                ; preds = %4, %8
  %9 = phi i64 [ 0, %4 ], [ %14, %8 ]
  %10 = phi i32 [ 0, %4 ], [ %13, %8 ]
  call void @llvm.dbg.value(metadata i64 %9, metadata !45, metadata !DIExpression()), !dbg !48
  call void @llvm.dbg.value(metadata i32 %10, metadata !44, metadata !DIExpression()), !dbg !47
  %11 = getelementptr inbounds i32, i32* %0, i64 %9, !dbg !53
  %12 = load i32, i32* %11, align 4, !dbg !53, !tbaa !28
  %13 = add nsw i32 %12, %10, !dbg !55
  call void @llvm.dbg.value(metadata i32 %13, metadata !44, metadata !DIExpression()), !dbg !47
  %14 = add nuw nsw i64 %9, 1, !dbg !56
  call void @llvm.dbg.value(metadata i64 %14, metadata !45, metadata !DIExpression()), !dbg !48
...
define dso_local void @processData(i32* nocapture noundef readonly %0, i32 noundef %1) local_unnamed_addr #0 !dbg !59 {
  ...
  call void @llvm.dbg.value(metadata i32* %0, metadata !42, metadata !DIExpression()), !dbg !65
  call void @llvm.dbg.value(metadata i32 %1, metadata !43, metadata !DIExpression()), !dbg !65
  call void @llvm.dbg.value(metadata i32 0, metadata !44, metadata !DIExpression()), !dbg !65
  call void @llvm.dbg.value(metadata i32 0, metadata !45, metadata !DIExpression()), !dbg !67
...
6:                                                ; preds = %6, %4
  %7 = phi i64 [ 0, %4 ], [ %12, %6 ]
  %8 = phi i32 [ 0, %4 ], [ %11, %6 ]
  call void @llvm.dbg.value(metadata i64 %7, metadata !45, metadata !DIExpression()), !dbg !67
  call void @llvm.dbg.value(metadata i32 %8, metadata !44, metadata !DIExpression()), !dbg !65
  %9 = getelementptr inbounds i32, i32* %0, i64 %7, !dbg !70
  %10 = load i32, i32* %9, align 4, !dbg !70, !tbaa !28
  %11 = add nsw i32 %10, %8, !dbg !71
  call void @llvm.dbg.value(metadata i32 %11, metadata !44, metadata !DIExpression()), !dbg !65
...
14:                                               ; preds = %6, %2
  ...
  call void @llvm.dbg.value(metadata i32 %15, metadata !63, metadata !DIExpression()), !dbg !64
...
define dso_local i32 @main() local_unnamed_addr #0 !dbg !80 {
  call void @llvm.dbg.declare(metadata [5 x i32]* @__const.main.arr, metadata !84, metadata !DIExpression()), !dbg !89
  call void @llvm.dbg.value(metadata i32 5, metadata !88, metadata !DIExpression()), !dbg !90
  %1 = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([16 x i8], [16 x i8]* @str.6, i64 0, i64 0)), !dbg !91
  call void @llvm.dbg.value(metadata i32 5, metadata !17, metadata !DIExpression()) #6, !dbg !92
  call void @llvm.dbg.value(metadata i32 0, metadata !18, metadata !DIExpression()) #6, !dbg !94
  br label %2, !dbg !95

2:                                                ; preds = %2, %0
  %3 = phi i64 [ 0, %0 ], [ %8, %2 ]
  call void @llvm.dbg.value(metadata i64 %3, metadata !18, metadata !DIExpression()) #6, !dbg !94
  ...
  call void @llvm.dbg.value(metadata i64 %8, metadata !18, metadata !DIExpression()) #6, !dbg !94
  %9 = icmp eq i64 %8, 5, !dbg !99
  br i1 %9, label %10, label %2, !dbg !95, !llvm.loop !100

10:                                               ; preds = %2
  call void @llvm.dbg.value(metadata i32 undef, metadata !45, metadata !DIExpression()), !dbg !102
  call void @llvm.dbg.value(metadata i32 undef, metadata !44, metadata !DIExpression()), !dbg !105
  call void @llvm.dbg.value(metadata i32 undef, metadata !44, metadata !DIExpression(DW_OP_LLVM_arg, 0, DW_OP_LLVM_arg, 1, DW_OP_plus, DW_OP_stack_value)), !dbg !105
  call void @llvm.dbg.value(metadata i32 15, metadata !63, metadata !DIExpression()) #6, !dbg !106
...
; RUN: opt -disable-output -passes=dummypass %s 2>&1 | FileCheck %s



; CHECK:Function: printArray
; CHECK: llvm.dbg.values : 5
; CHECK:  llvm.dbg.declare : 0

; CHECK:Function: sumArray
; CHECK: llvm.dbg.values : 8
; CHECK:  llvm.dbg.declare : 0

; CHECK:Function: processData
; CHECK:  llvm.dbg.values : 11
; CHECK:  llvm.dbg.declare : 0

; CHECK:Function: main
; CHECK:  llvm.dbg.values : 9
